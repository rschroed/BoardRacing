...
**Status:** Software-ready as of July 13, 2026. Deterministic strategy, presentation, balance, the complete 71-test automated/simulator pass, and the exact-candidate Android inspection/deployment smoke test are recorded in the [Tranche 3 proof](testing/tranche-3-pit-crew-proof.md) and [simulator/Android validation](testing/tranche-3-simulator-android-validation.md). The tranche remains in progress until the two-person physical gate in [Issue #49](https://github.com/rschroed/BoardRacing/issues/49) passes.
